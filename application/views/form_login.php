              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <img src="<?php echo base_url('assets/img/zens3.png') ?>" width="120px" class="mb-4">
                  </div>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url('registrasi/index') ?>">Ingin mendaftar? Daftar sekarang!</a>
                  </div>
                </div>
              </div>
            </div>
